  ...
  return <footer className="bg-primary-100 py-16">
    <div className="justify-content mx-auto w-5/6 gap-16 md:flex">
        <div className="mt-16 basis-1/2 md:mt-0">
            ...
            <p className="my-5 ">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis nemo iusto 
                similique optio explicabo modi deleniti aliquid quo porro obcaecati suscipit 
