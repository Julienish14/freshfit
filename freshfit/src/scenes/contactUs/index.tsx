    ...
    <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
        ...
        >
            ...
            <p className="my-5">
                ...
                commodi nemo minima! Alias fuga dignissimos deleniti tempora eveniet repellat 
                commodi delectus corporis.
            </p>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
            ...
            >
                <form
                    target="_blank"
                    onSubmit={onSubmit}
                    action="https://formsubmit.co/7de8132fcfd3b29fb39b587e36f07d46"
                    method="POST"
                >
                    <input 
